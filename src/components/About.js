	...
	return (
		<div className='About-text'>
			<h3 className='About-title'>
				Whether you represent the condemnor or the landowner, I look forward to
			...
			<p className='About-p'>
				...
				hundreds of eminent domain cases over the past three decades uniquely
				qualifies me as a mediator specializing in this field. Only an eminent
				domain lawyer can understand the particular legal issues involved, the
				nuances of appraisals, and the motivations involved in a condemnation
				dispute. <br />
				<br />
