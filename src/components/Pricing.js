...
export default function Pricing() {
	return (
		<main className='Pricing-all'>
			...
			<p className='Pricing-text'>
				{' '}
				Typically, mediations will be conducted at my Corsicana office (located
				at 504 West 2nd Ave., Corsicana,TX.) I will travel if preferred and/or
				necessary, with travel rates of $150/hour applicable. <br />
